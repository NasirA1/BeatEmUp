...
PlayerIdleState::PlayerIdleState()
    : m_sprite_right(ResourceManager::instance().getTexture("C:\\Users\\Nasir\\Desktop\\cutegirl_idle_right.png"), tileWidth, tileHeight)
    , m_sprite_left(ResourceManager::instance().getTexture("C:\\Users\\Nasir\\Desktop\\cutegirl_idle_left.png"), tileWidth, tileHeight)
